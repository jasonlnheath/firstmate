...
state/               runtime records and signals; gitignored
  ...
  .helm-reset.refusal .helm-reset.last  the latest gated helm-reset refusal (gate + reason, for morning diagnosis) and the last completed dry-run or real reset record; bin/fm-helm-reset.sh
